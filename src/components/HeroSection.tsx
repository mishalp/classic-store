...
function HeroSection() {
    return (
        <div className="grid grid-cols-1 sm:max-lg:grid-rows-2 bg-[#E0E0E0] lg:grid-cols-7 lg:gap-8 content-around w-full h-screen relative">
            ...
            <div className="lg:h-screen lg:max-xl:pt-20 justify-center xl:grid flex flex-col-reverse lg:flex-col-reverse lg:justify-center sm:flex-row-reverse sm:justify-around lg:col-span-3 sm:max-xl:py-8 sm:bg-[#1A1B23] place-items-center relative">
