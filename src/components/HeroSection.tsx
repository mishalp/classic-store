...
function HeroSection() {
    return (
        <div className="grid grid-cols-1 sm:max-lg:grid-rows-2 bg-[#E0E0E0] lg:grid-cols-7 lg:gap-8 content-around w-full h-screen lg:h-[90vh] relative">
            <div className="lg:h-screen max-lg:px-4 lg:col-span-4 grid lg:pl-16 items-center pt-20 justify-start">
                <div className="grid text-[#1C2541] justify-items-start gap-2 lg:gap-4">
            ...
            <div className="lg:h-[90vh] lg:max-xl:pt-20 justify-center xl:grid flex flex-col-reverse lg:flex-col-reverse lg:justify-center sm:flex-row-reverse sm:justify-around lg:col-span-3 sm:max-xl:py-8 sm:bg-[#1A1B23] place-items-center relative">
                ...
                <Image width={300} height={300} src="/headset.png" className="xl:absolute w-52 lg:max-xl xl:w-auto top-52 z-[1] lg:-left-44" alt="product image" />
            </div>
        </div>
    )
}
